...
Open-source **Flask/Jinja Template** generated by `AppSeed` op top of **[Argon Dashboard](https://appseed.us/product/argon-dashboard/flask/)**, a modern `Bootstrap 5` dashboard design. The project is a super simple Flask project WITHOUT database, ORM, or any other hard dependency. The project can be used as a codebase for future project or to migrate the Jinja files and assets to a legacy Python-based project that uses Jinja as template engine (Flask, Bottle, Django).
...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-06-30 15:46`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c1955306-b063-43b7-8d92-a42531bbd330.git
$ cd c1955306-b063-43b7-8d92-a42531bbd330
```
...
## [Argon Dashboard PRO Flask](https://appseed.us/product/argon-dashboard-pro/flask/)
